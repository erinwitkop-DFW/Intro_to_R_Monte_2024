...
ggplot(data = stat_fork_length, mapping = aes(x=stat_week_sun_sat, y= mean_fork_length, color = species)) +
   geom_line() +
   facet_wrap(vars(species, wria)) +
   theme_bw()+
  scale_color_manual( name = "Species", values = c("blue", "orange", "gray"))
...
ggplot(data = yearly_sex_counts, aes(x = stat_week_sun_sat, y = n, color = species)) +
  geom_line() +
  labs(title = "Species Returns over Time") +
  scale_color_manual(name = "Species", values = c("blue", "orange","red")) +
  theme(axis.text.x = element_text(size = 12, angle = 90), plot.title = element_text(face = "italic")) +
